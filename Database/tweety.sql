...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2023 at 02:07 PM
...
CREATE TABLE `comments` (
  ...
  `comment` varchar(140) COLLATE utf16_unicode_ci NOT NULL NOT NULL ,
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `screenName`, `profileImage`, `profileCover`, `following`, `followers`, `bio`, `country`, `website`, `created_at`) VALUES
(1, 'chaurasia20', 'chaurasia@gmail.com', 'ab84e1ad31337246d6d98e3ca709eeaf', 'Yash Chaurasia', 'users/eat-sleep-code-repeat-saying-t-shirt-for-coder-vector-31386255.jpg', 'users/coding.png', 0, 0, 'Full Stack Developer | Freelancer', 'India', 'www.chaurasia.com', 0),
(2, 'kartik001', 'kartik@gmail.com', 'c8d39cdb56a46ad807969ee04c4e660b', 'Kartik Choubey', 'users/download.png', 'users/Dev wallpaper 1.jpg', 0, 0, 'BCA Student | Freelancer', 'India', 'www.kartik.com', 0),
(3, 'naman1999', 'naman@gmail.com', '98c8bc837481b93acfb0deef65e50127', 'Naman Jain', 'users/avtar2.jpg', 'users/Dev wallpaper 2.jpg', 0, 2, 'UI/UX Designer | Website Designer', 'India', 'www.naman.com', 0),
(4, 'nikhil01', 'nikhil@gmail.com', '350d89c1cd6592bbbd1ed2e8a4f3ddba', 'Nikhil Yadav', 'users/avtar.png', 'users/code.jpg', 2, 1, 'Software Developer | Freelancer', 'India', 'www.nikhil.com', 0),
(5, 'yashgaur908', 'yash@gmail.com', 'e76eb8a75988cb07c8428733a5dd4684', 'Yash Gaur', 'users/avtar1.jpg', 'users/Dev wallpaper.jpg', 2, 1, 'Software Developer | Website Designer', 'India', 'www.yashgaur.tk', 0);
