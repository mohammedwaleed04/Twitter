...
-->
                        ...
                        <div class="edit-button d-flex">
                            <span>
                                <button class="new-btn mr-3" type="button" onclick="window.location.href='<?php echo BASE_URL; ?>profile.php?username=<?php echo $user->username; ?>'" value="Cancel" style="outline:none;">Cancel</button>
                            </span>
                            <span>
